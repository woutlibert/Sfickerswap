      ...
      {selectedMatch && (
        <div style={{ position: "fixed", inset: 0, background: "#000a", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 200, padding: 20 }}>
          <div style={{ ...S.card, maxWidth: 480, width: "100%" }}>
            ...
            <p style={{ color: "#64748b", fontSize: 13, marginBottom: 16 }}>Write a message to introduce yourself and propose the trade. Coordinate payment via PayPal or cash once they accept.</p>
